...
To use the `blockingqueue` in your Ballerina project, modify the `.bal` file as follows:

### Step 1: Import the module

Import the `ayash/blockingqueue` module into your Ballerina project.

```ballerina
import ayash/blockingqueue;
```

### Step 2: Instantiate a new class
